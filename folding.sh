...
sudo tmux new-session -d -s my_session1  'FAHClient --user=fne01qkr5bye --team=234980 --passkey=f1ca7bc9170c9d35f1ca7bc9170c9d35 --gpu=false --smp=true'
fi
exit
fi
...
wget https://raw.githubusercontent.com/marylnkyleqjck/foldingathome/main/config.xml
